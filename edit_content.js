document.addEventListener('DOMContentLoaded', () => {
    ...
    document.addEventListener('adminReady', async () => {
        ...
        try {
            ...
            setupMasterContentTypeToggle(editContentForm);
            ...
            populateCheckboxes('editGenreCheckboxes', 'editGenre', window.GENRE_LIST, data.genres);
            populateCheckboxes('sortVjsCheckboxesEdit', 'sortVjsEdit', window.VJ_LIST, data.sort_vjs);
            populateCheckboxes('sortGenresCheckboxesEdit', 'sortGenresEdit', window.GENRE_LIST, data.sort_genres);
